package com.example.mediaplayerstream;
...
public void onCreate(Bundle savedInstanceState) {
	...
	String filePath = "http://v2.cache2.c.youtube.com/CjgLENy73wIaLwm3JbT_9HqWohMYESARFEIJbXYtZ29vZ2xlSARSB3Jlc3VsdHNg96LUzsK0781MDA==/0/0/0/video.3gp";;
	try {
...
public boolean onError(MediaPlayer ap, int whatError, int extra) {
...
public void onVideoSizeChanged(MediaPlayer mp, int width, int height) {
	...
	if (videoWidth > currentDisplay.getWidth() || videoHeight > currentDisplay.getHeight()) {
		...
		if (heightRatio > 1 || widthRatio > 1) {
			...
			} else {videoHeight = (int) Math.ceil((float) videoHeight/ (float) widthRatio);
